...
from Insane import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Insane import boottime as bot_start_time
from Insane import db, random_assistant
from Insane.Core.PyTgCalls import Insane
from Insane.Database import (add_nonadmin_chat, add_served_chat,
...
from Insane.Decorators.admins import ActualAdminCB
from Insane.Inline import (custommarkup, dashmarkup, setting_markup,
                          setting_markup2, start_pannel, usermarkup, volmarkup)
from Insane.Utilities.assistant import get_assistant_details
from Insane.Utilities.ping import get_readable_time
...
# Copyright (C) 2021 By @always_hungry365
...
async def useradd(_, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/c1ca97093abb67d0a315f.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 ʜᴇʟʟᴏ, ɪ ᴀᴍ Insane sᴜᴘᴇʀ ғᴀsᴛ ᴠᴄ ᴘʟᴀʏᴇʀ
ʙᴏᴛ ғᴏʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘs ᴛᴏ ᴘʟᴀʏ ᴀᴜᴅɪᴏ ᴀɴᴅ ᴠɪᴅᴇᴏ sᴏɴɢ...
┏━━━━━━━━━━━━━━━━━┓
┣★ ᴄʀᴇᴀᴛᴏʀ › : [Mayank](https://t.me/always_hungry365)
┣★ sᴜᴘᴘᴏʀᴛ › : [Apni Mehfil](https://t.me/Dosto_ki_Mehfil786)
┣★ ʀᴏᴄᴋsᴏᴘ › : [ɴᴇᴛᴡᴏʀᴋ](https://t.me/Dosto_ki_Mehfil786)
┣★ ʙʀᴏᴛʜᴇʀ › : [ᴍʏ ʙʀᴏ](https://t.me/IRFANMOHD786)
┣★ ʜᴇʟᴘ › : ɴᴇᴇᴅ ʜᴇʟᴘ ʀᴜɴ /help
┗━━━━━━━━━━━━━━━━━┛

💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ
ᴅᴍ ᴛᴏ ᴍʏ [ʟᴇɢᴇɴᴅ ᴏᴡɴᴇʀ](https://t.me/always_hungry365) ...
━━━━━━━━━━━━━━━━━━━━━━━━**""",
   reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ ᴀᴅᴅ Insane ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ❱ ➕", url=f"https://t.me/Insane_Music_Bot?startgroup=true")
                ]
...
@app.on_message(filters.command(["alive", "reload", "Insane"]) & filters.private & ~filters.group & ~filters.edited)
async def useradd(_, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💥 ᴊᴏɪɴ ʜᴇʀᴇ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ 💞", url=f"https://t.me/Dosto_ki_Mehfil786")
                ]
            ]
        ),
    )
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💥 ᴄʟɪᴄᴋ ᴍᴇ ᴛᴏ ɢᴇᴛ ʀᴇᴘᴏ 💞", url=f"https://t.me/@always_hungry365")
                ]
            ]
        ),
    )
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"Insane Disk Usage: {diske}%", show_alert=True
        )
