...
from Insane.Core.PyTgCalls.Insane import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from Insane.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from Insane.Decorators.admins import AdminRightsCheck
from Insane.Decorators.checker import checker, checkerCB
from Insane.Inline import audio_markup, primary_markup, secondary_markup2
